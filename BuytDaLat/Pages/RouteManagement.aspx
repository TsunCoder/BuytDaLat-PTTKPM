    ...
    <form class="form1" id="form1" runat="server">
            ...
            <asp:Panel CssClass="panel1 mt-3 p-4" ID="Panel1" runat="server" Visible="false">
                ...
                <div class="form-group border">
                    ...
                    <div class="form-group mt-3 ml-4">
                        ...
                        <asp:Button ID="btnCancelFormAdd" runat="server" Text="Thoát" CssClass="btn" OnClick="btnCancelFormAdd_Click" />
                    </div>
                </div>
        ...
        <div class="table_panel bg-light mb-3">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:Panel CssClass=" mt-2 px-4 py-3" ID="pnTable" runat="server">
                        <div class="">
